...
export const arakochyla: FlatNode[] = [
    {   
        ...
        parent: null,
        name: "Arakochylan",
        desc: `Arakochylans are small (10-50cm) carnivorous Ypokinites, that first evolved in the early Oberian. They have a calcareous shell which houses the main body; this shell attaches itself to rocks on the sea floor. From this shell extend tantacle-like appendages. These appendages grab small ypokinites and push them into the shell, where they are digested. The ends of these appendages flare out into gill like structures which are used for taking oxygen from the surrounding water.`,
