...
function Planet() {
  return (
    <>
      ...
      />
      <FileLink
        fileLink={"src/img/annwn_2000.png"}
        caption={"annwn.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/new_moon.png"}
        caption={"new_moon.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/waxing_crescent.png"}
        caption={"waxing_crescent.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/first_quarter.png"}
        caption={"first_quarter.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/waxing_gibbous.png"}
        caption={"waxing_gibbous.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/full_moon.png"}
        caption={"full_moon.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/waning_gibbous.png"}
        caption={"waning_gibbous.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/third_quarter.png"}
        caption={"third_quarter.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/waning_crescent.png"}
      ...
      />
      <FileLink
        fileLink={"src/img/1900-1.png"}
        caption={"annwn_100_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1900-2.png"}
        caption={"annwn_100_2.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1900Ma.png"}
      ...
      />
      <FileLink
        fileLink={"src/img/1800-1.png"}
        caption={"annwn_200_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1800-2.png"}
        caption={"annwn_200_2.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1800-3.png"}
        caption={"annwn_200_3.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1800Ma.png"}
      ...
      />
      <FileLink
        fileLink={"src/img/1700-1.png"}
        caption={"annwn_300_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1700-2.png"}
        caption={"annwn_300_2.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1700Ma.png"}
      ...
      />
      <FileLink
        fileLink={"src/img/1500-1.png"}
        caption={"annwn_500_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1500-2.png"}
        caption={"annwn_500_2.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1500-3.png"}
        caption={"annwn_500_3.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1500Ma.png"}
      ...
      />
      <FileLink
        fileLink={"src/img/1400-1.png"}
        caption={"annwn_600_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1400-2.png"}
        caption={"annwn_600_2.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1400-3.png"}
        caption={"annwn_600_3.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1400-4.png"}
        caption={"annwn_600_4.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1400Ma.png"}
      ...
      />
      <FileLink
        fileLink={"src/img/1300-1.png"}
        caption={"annwn_700_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1300-2.png"}
        caption={"annwn_700_2.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1300-3.png"}
        caption={"annwn_700_3.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1300-4.png"}
        caption={"annwn_700_4.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1300-5.png"}
        caption={"annwn_700_5.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/1300Ma.png"}
      ...
      />
      <FileLink
        fileLink={"src/img/topomap.png"}
        caption={"annwn_topo_850.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/climate.png"}
        caption={"annwn_climate_zones.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/wind1.png"}
        caption={"prevailing_winds_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/wind2.png"}
        caption={"prevailing_winds_2.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/currents1.png"}
        caption={"ocean_currents_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/currents2.png"}
        caption={"ocean_currents_2.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/rain1.png"}
        caption={"precipitation_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/rain2.png"}
        caption={"precipiation_2.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/temp1.png"}
        caption={"temperature_1.img"}
        icoSource={"src/img/ico/imgIco.png"}
      />
      <FileLink
        fileLink={"src/img/temp2.png"}
